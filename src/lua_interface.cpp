...
//   cout << "Parsed minutes_to_stop_before_max_run_time (or default if missing) : " << pvMap["minutes_to_stop_before_max_run_time"] << endl;
   ...
   */
  sol::optional<lua_function_state_init> mandatory_state_init = lua.get<lua_function_state_init>("state_init");
  ...
  sol::optional<lua_function_check_state> mandatory_check_state_left = lua.get<lua_function_check_state>("check_state_left");
  ...
  sol::optional<lua_function_data_save> mandatory_save_conditions = lua.get<lua_function_data_save>("save_FV_initial_conditions");
  if(mandatory_save_conditions)
  {
    func_save_conditions = mandatory_save_conditions.value();
  }
  else
  {
